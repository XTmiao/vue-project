		...
		<table>
			<tbody>
				<tr>
					<td>登录密码</td>
					<td>
						<input type="password" class="input" tag="登录密码" v-va:Password v-model.trim="Password" placeholder="请输入登录密码">
					</td>
				</tr>
				<tr>
					<td>确认密码</td>
					<td>
						<input type="password" class="input" v-va:checkPassword.Password="[{'equal':'Password'}]" tag="确认密码" v-model.trim="checkPassword" placeholder="请再次输入密码">
					</td>
				</tr>
				<tr></tr>
			</tbody>
		</table>
		<div class="loginBrn BTN"><a v-va-check>提交</a></div>
	</div>
</template>
